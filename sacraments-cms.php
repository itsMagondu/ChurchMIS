...
if ((isset($_POST["savebaptism"]))) {
  ...
  $insertSQL = sprintf("INSERT INTO baptism (baptismid, memberid, date_baptised,leaderid,geust_leader,male_god_parent,female_god_parent,baptism_venue,parish_name, baptismcert_no) VALUES (%s, %s, %s, %s, %s, %s,%s,%s,%s,%s)",
					   ...
					   GetSQLValueString($_POST['parish_name'], "text"),
...
if ((isset($_GET['baptismid'])) && ($_GET['baptismid']!="")){
  ...
  $updateSQL = sprintf("UPDATE baptism SET memberid=%s, date_baptised=%s, leaderid=%s, geust_leader=%s,male_god_parent=%s,female_god_parent=%s,baptism_venue=%s, parish_name=%s, baptismcert_no=%s WHERE baptismid=".$_GET['baptismid']."",
                       GetSQLValueString($_POST['memberid'], "int"),
                       GetSQLValueString($_POST['date_baptised'], "text"),
                       GetSQLValueString($_POST['leaderid'], "int"),
                       GetSQLValueString($_POST['geust_leader'], "text"),
...
mysql_select_db($database_church, $church);
$query_viewbaptism = "SELECT * FROM baptism b INNER JOIN member_details m ON b.memberid=m.memberid LEFT JOIN leader l on b.leaderid=l.leaderid";
...
if ((isset($_GET['Delete']) &&(isset($_GET['first_confirmationid'])) && ($_GET['first_confirmationid'] != ""))) {
	
	   $tab="index.php?sacraments=true#tabs-2";
	$whereto=$tab;	
	
$deleteSQL = sprintf("DELETE FROM first_confirmation WHERE first_confirmationid=".($_GET['first_confirmationid'])."", 
                       GetSQLValueString($_GET['first_confirmationid'], "int"));
...
if ((isset($_POST["confirmation"]))) {
  ...
  $insertSQL = sprintf("INSERT INTO first_confirmation (firstconfirmation_date, memberid,male_god_parent,female_god_parent, leaderid, geust_leader,preconfirmation_venue, first_confirmationcert_no) VALUES (%s, %s, %s, %s, %s,%s,%s,%s)",
...
if ((isset($_GET['first_confirmationid'])) && ($_GET['first_confirmationid']!="")){
  ...
  $updateSQL = sprintf("UPDATE first_confirmation SET firstconfirmation_date=%s, memberid=%s,male_god_parent=%s,female_god_parent=%s, leaderid=%s, geust_leader=%s, preconfirmation_venue=%s,first_confirmationcert_no=%s WHERE first_confirmationid=".$_GET['first_confirmationid']."",
                       GetSQLValueString($_POST['firstconfirmation_date'], "text"),
                       GetSQLValueString($_POST['memberid'], "int"),
					  GetSQLValueString($_POST['male_god_parent'], "text"),
					  GetSQLValueString($_POST['female_god_parent'], "text"),
...
if((isset($_GET['first_confirmationid'])) &&($_GET['first_confirmationid']!="")){
mysql_select_db($database_church, $church);
$query_editfirstconfirmation = "SELECT * FROM first_confirmation f INNER JOIN member_details m ON f.memberid=m.memberid INNER JOIN leader l ON f.leaderid=l.leaderid WHERE first_confirmationid=".$_GET['first_confirmationid']." ";
...
$maxRows_viewfirstconfirmation = 50;
...
mysql_select_db($database_church, $church);
$query_viewfirstconfirmation = "SELECT * FROM first_confirmation f INNER JOIN member_details m ON f.memberid=m.memberid";
...
$queryString_addmember = "";
if (!empty($_SERVER['QUERY_STRING'])) {
  $params = explode("&", $_SERVER['QUERY_STRING']);
  $newParams = array();
  foreach ($params as $param) {
    if (stristr($param, "pageNum_addmember") == false && 
        stristr($param, "totalRows_addmember") == false) {
      array_push($newParams, $param);
    }
  }
  if (count($newParams) != 0) {
    $queryString_addmember = "&" . htmlentities(implode("&", $newParams));
  }
}
$queryString_addmember = sprintf("&totalRows_addmember=%d%s", $totalRows_addmember, $queryString_addmember);



if ((isset($_GET['Delete']) &&(isset($_GET['second_confirmationid'])) && ($_GET['second_confirmationid'] != ""))) {
	
	   $tab="index.php?sacraments=true#tabs-3";
	$whereto=$tab;	
	
$deleteSQL = sprintf("DELETE FROM second_confirmation  WHERE second_confirmationid=".($_GET['second_confirmationid'])."", 
                       GetSQLValueString($_GET['second_confirmationid'], "int"));
...
if ((isset($_POST["secondconfirmation"]))) {
  ...
  $insertSQL = sprintf("INSERT INTO second_confirmation (memberid,male_god_parent,female_god_parent, secondconfirmation_date, leaderid, geust_leader, second_confirmationcert_no) VALUES (%s, %s, %s, %s, %s,%s,%s)",
...
if ((isset($_POST["updatesecondconfirmation"]))) {
  ...
  $updateSQL = sprintf("UPDATE second_confirmation SET memberid=%s,male_god_parent=%s,female_god_parent=%s, secondconfirmation_date=%s, leaderid=%s, geust_leader=%s, second_confirmationcert_no=%s WHERE second_confirmationid=".$_GET['second_confirmationid']."",
                       GetSQLValueString($_POST['memberid'], "int"),
					   GetSQLValueString($_POST['male_god_parent'], "text"),
				        GetSQLValueString($_POST['female_god_parent'], "text"),
                       GetSQLValueString($_POST['secondconfirmation_date'], "text"),
...
$totalRows_addsecondconfirmation = mysql_num_rows($addsecondconfirmation);
	...
	if((isset($_GET['second_confirmationid']) && ($_GET['second_confirmationid']!==""))){
mysql_select_db($database_church, $church);
$query_editsecondconfirmation = "SELECT * FROM second_confirmation";
...
$maxRows_viewsecondconfirmation = 50;
...
mysql_select_db($database_church, $church);
$query_viewsecondconfirmation = "SELECT * FROM second_confirmation s  INNER JOIN leader l ON l.leaderid=s.leaderid 
 LEFT JOIN member_details md ON md.memberid=s.memberid 
";
...
if ((isset($_GET['Delete']) &&(isset($_GET['marriageid'])) && ($_GET['marriageid'] != ""))) {
	
	   $tab="index.php?sacraments=true#tabs-4";
	$whereto=$tab;	
	
$deleteSQL = sprintf("DELETE FROM marriage  WHERE marriageid=".($_GET['marriageid'])."", 
                       GetSQLValueString($_GET['marriageid'], "int"));
...
if ((isset($_POST["savemarriage"]))) {
  ...
  $insertSQL = sprintf("INSERT INTO marriage (marriageid, husbandname,husband, wifenameid,wife,best_man,best_maid, marriage_date, leaderid,solemnization_venue, marriagecert_no) VALUES (%s, %s, %s, %s, %s, %s,%s,%s,%s,%s,%s)",
                       GetSQLValueString($_POST['marriageid'], "int"),
                       GetSQLValueString($_POST['husbandname'], "int"),
...
mysql_select_db($database_church, $church);
$query_editmarriage = "SELECT * FROM marriage m LEFT JOIN member_details md ON m.wifenameid=md.memberid WHERE md.memberid=".$_GET['marriageid']."";
...
mysql_select_db($database_church, $church);
$query_viewmarriage = "SELECT * FROM marriage ";
...
<ul>
        ...
        <li><a href="#tabs-4">Holy Matrimony</a></li>
...
do {  
?>
        <option value="<?php echo $row_addmember['memberid']?>" ><?php echo $row_addmember['lastname']?>&nbsp;<?php echo $row_addmember['firstname']?>&nbsp;<?php echo $row_addmember['middlename']?></option>
        <?php
...
?>
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Guest Leader:</td>
      <td><input type="text" name="geust_leader" value="<?php echo htmlentities($row_editbaptism['geust_leader'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
     <tr valign="baseline">
     ...
     <tr valign="baseline">
      <td nowrap="nowrap" align="right">Parish Name:</td>
      <td><span id="sprytextfield1">
        <input type="text" name="parish_name" value="<?php echo htmlentities($row_editbaptism['parish_name'], ENT_COMPAT, 'utf-8'); ?>" size="32" />
        <span class="textfieldRequiredMsg">A value is required.</span></span></td>
    </tr>
  ...
  <table border="1" align="center">
   ...
   <td width="10%">Member Names</td>
      <td width="4%">Date</td>
      <td width="8%">Officiating Clergy</td>
       <td width="8%">Male god  Parent</td>
      <td width="8%">Female god Parent</td>
      <td width="9%">Geust Leader</td>
      <td width="10%">Baptism Cert_Number</td>
      <td width="4%">&nbsp;</td>
      <td width="4%">&nbsp;</td>
    </tr>
    <?php    ?>
...
$totalRows_viewleaderbaptism = mysql_num_rows($viewleaderbaptism);
	...
	?>
      <tr>
        <td><?php  echo $numb;?></td>
        <td><?php echo $row_viewbaptism['lastname']; ?>&nbsp;<?php echo $row_viewbaptism['firstname']; ?>&nbsp;<?php echo $row_viewbaptism['middlename']; ?> </td>
        <td><?php echo $row_viewbaptism['date_baptised']; ?>&nbsp; </td>
        <td><?php echo $row_viewleaderbaptism['firstname']; ?>&nbsp;<?php echo $row_viewleaderbaptism['middlename']; ?>&nbsp;<?php echo $row_viewleaderbaptism['lastname']; ?></td>
        <td><?php echo $row_viewbaptism['male_god_parent']; ?>&nbsp; </td>
          <td><?php echo $row_viewbaptism['female_god_parent']; ?>&nbsp; </td>
        <td><?php echo $row_viewbaptism['geust_leader']; ?>&nbsp; </td>
  ...
  ?>
   ...
   <td><a href="index.php?sacraments=show & baptismid=<?php echo $row_viewbaptism['baptismid'];?> & Delete=1 &#tabs-1" onClick="return confirm('Are you sure you want to delete?')"> Delete </a></td>
...
?>
    ...
    <tr valign="baseline">
      ...
      <td>
    <select name="leaderid" selected="selected">
       <option value="-1"  <?php if (!(strcmp(-1,                 $row_editfirstconfirmation['baptismid']))) {echo "selected=\"selected\"";} ?>>Select Leader</option>
       <?php
do {  
?>
       <option value="<?php echo $row_addleader1['memberid']?>"<?php if (!(strcmp($row_addleader1['memberid'], $row_editfirstconfirmation['first_confirmationid']))) {echo "selected=\"selected\"";} ?>><?php echo $row_addleader1['firstname']?> <?php echo $row_addleader1['middlename']?> <?php echo $row_addleader1['lastname']?></option>
       <?php
} while ($row_addleader1 = mysql_fetch_assoc($addleader1));
  $rows = mysql_num_rows($addleader1);
  if($rows > 0) {
...
?>
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Guest Leader:</td>
      <td><input type="text" name="geust_leader" value="<?php echo htmlentities($row_editfirstconfirmation['geust_leader'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
...
$totalRows_leaderfirstconfirmation = mysql_num_rows($leaderfirstconfirmation);
	...
	?>
      <tr>
        <td><?php echo  $rawnum; ?></td>
            <td><?php echo $row_viewfirstconfirmation['lastname']; ?>&nbsp; <?php echo $row_viewfirstconfirmation['firstname']; ?>&nbsp;<?php echo $row_viewfirstconfirmation['middlename']; ?></td>
        <td><?php echo $row_viewfirstconfirmation['firstconfirmation_date']; ?>&nbsp; </td>
    
        <td><?php echo $row_leaderfirstconfirmation['firstname']; ?>&nbsp; <?php echo $row_leaderfirstconfirmation['middlename']; ?>&nbsp;<?php echo $row_leaderfirstconfirmation['lastname']; ?></td>
        <td><?php echo $row_viewfirstconfirmation['geust_leader']; ?>&nbsp; </td>
  ...
  ?>
   ...
   <td><a href="index.php?sacraments=show & first_confirmationid=<?php echo $row_viewfirstconfirmation['first_confirmationid'];?> & Delete=1 &#tabs-2" onClick="return confirm('Are you sure you want to delete?')"> Delete </a></td>
  ...
  <table border="0">
    <tr>
      <td><?php if ($pageNum_addmember > 0) { // Show if not first page ?>
          <a href="<?php printf("%s?pageNum_addmember=%d%s", $currentPage, 0, $queryString_addmember); ?>">First</a>
          <?php } // Show if not first page ?></td>
      <td><?php if ($pageNum_addmember > 0) { // Show if not first page ?>
          <a href="<?php printf("%s?pageNum_addmember=%d%s", $currentPage, max(0, $pageNum_addmember - 1), $queryString_addmember); ?>">Previous</a>
          <?php } // Show if not first page ?></td>
      <td><?php if ($pageNum_addmember < $totalPages_addmember) { // Show if not last page ?>
          <a href="<?php printf("%s?pageNum_addmember=%d%s", $currentPage, min($totalPages_addmember, $pageNum_addmember + 1), $queryString_addmember); ?>">Next</a>
          <?php } // Show if not last page ?></td>
      <td><?php if ($pageNum_addmember < $totalPages_addmember) { // Show if not last page ?>
          <a href="<?php printf("%s?pageNum_addmember=%d%s", $currentPage, $totalPages_addmember, $queryString_addmember); ?>">Last</a>
          <?php } // Show if not last page ?></td>
    </tr>
  </table>
Records <?php echo ($startRow_addmember + 1) ?> to <?php echo min($startRow_addmember + $maxRows_addmember, $totalRows_addmember) ?> of <?php echo $totalRows_addmember ?>
</form>
 </div>
 ...
 <div id="tabs-3">
    ...
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" class="mainbodyview">
      ...
      <td nowrap="nowrap" align="right">Member:</td>
          <?php  mysql_select_db($database_church, $church);
$query_addmember = "SELECT  *  FROM  member_details m";
$query_limit_addmember = sprintf("%s LIMIT %d, %d", $query_addmember, $startRow_addmember, $maxRows_addmember);
$addmember = mysql_query($query_limit_addmember, $church) or die(mysql_error());
$row_addmember = mysql_fetch_assoc($addmember); 
?>
...
?>
    ...
    <tr valign="baseline">
      ...
      <td>
    <select name="leaderid" selected="selected" >
       <option value="-1"  <?php if (!(strcmp(-1,                 $row_editsecondconfirmation['second_confirmationid']))) {echo "selected=\"selected\"";} ?>>Select Leader</option>
       <?php
do {  
?>
       <option value="<?php echo $row_addleader1['memberid']?>"<?php if (!(strcmp($row_addleader1['memberid'], $row_editsecondconfirmation['second_confirmationid']))) {echo "selected=\"selected\"";} ?>><?php echo $row_addleader1['firstname']?> <?php echo $row_addleader1['middlename']?> <?php echo $row_addleader1['lastname']?></option>
       <?php
} while ($row_addleader1 = mysql_fetch_assoc($addleader1));
...
?>
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Guest Leader:</td>
      <td><input type="text" name="geust_leader" value="<?php echo htmlentities($row_editsecondconfirmation['geust_leader'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
  ...
  <table border="1" align="center">
    <tr>
       ...
       <td width="2%">No</td>
       <td width="7%">Member Names </td>
     <td width="4%">Date</td>
       <td width="7%">Officiating  Clergy</td>
      <td width="7%">Geust Leader</td>
    <td width="8%">Confirmation Certificate Number</td>
      <td width="4%">&nbsp;</td>
     <td width="4%">&nbsp;</td>
    </tr>
    <?php do { $numcon++;
mysql_select_db($database_church, $church);
$query_confirmationleader= "SELECT * FROM second_confirmation s INNER JOIN leader l ON s.leaderid=l.leaderid INNER JOIN member_details md ON md.memberid=l.memberid WHERE s.leaderid=". $row_viewsecondconfirmation['leaderid']." ";
$confirmationleader = mysql_query($query_confirmationleader, $church) or die('error');
$row_confirmationleader = mysql_fetch_assoc($confirmationleader);
$totalRows_confirmationleader= mysql_num_rows($confirmationleader);
	...
	?>
      <tr>
        ...
        <td><?php echo $row_viewsecondconfirmation['lastname']; ?>&nbsp;<?php echo $row_viewsecondconfirmation['firstname']; ?>&nbsp;<?php echo $row_viewsecondconfirmation['lastname']; ?> </td>
        <td><?php echo $row_viewsecondconfirmation['secondconfirmation_date']; ?>&nbsp; </td>
        <td><?php echo $row_confirmationleader['firstname']; ?>&nbsp;<?php echo $row_confirmationleader['middlename']; ?>&nbsp;<?php echo $row_confirmationleader['lastname']; ?> </td>
        <td><?php echo $row_viewsecondconfirmation['geust_leader']; ?>&nbsp; </td>
  ...
  ?>
   ...
   <td><a href="index.php?sacraments=show & second_confirmationid=<?php echo $row_viewsecondconfirmation['second_confirmationid'];?> & Delete=1 &#tabs-3" onClick="return confirm('Are you sure you want to delete?')"> Delete </a></td>
      </tr>
	  <?php }?>
  ...
  <table border="0">
    <tr>
      <td><?php if ($pageNum_viewsecondconfirmation > 0) { // Show if not first page ?>
          <a href="<?php printf("%s?pageNum_viewsecondconfirmation=%d%s", $currentPage, 0, $queryString_viewsecondconfirmation); ?>">First</a>
          <?php } // Show if not first page ?></td>
      <td><?php if ($pageNum_viewsecondconfirmation > 0) { // Show if not first page ?>
          <a href="<?php printf("%s?pageNum_viewsecondconfirmation=%d%s", $currentPage, max(0, $pageNum_viewsecondconfirmation - 1), $queryString_viewsecondconfirmation); ?>">Previous</a>
          <?php } // Show if not first page ?></td>
      <td><?php if ($pageNum_viewsecondconfirmation < $totalPages_viewsecondconfirmation) { // Show if not last page ?>
          <a href="<?php printf("%s?pageNum_viewsecondconfirmation=%d%s", $currentPage, min($totalPages_viewsecondconfirmation, $pageNum_viewsecondconfirmation + 1), $queryString_viewsecondconfirmation); ?>">Next</a>
          <?php } // Show if not last page ?></td>
      <td><?php if ($pageNum_viewsecondconfirmation < $totalPages_viewsecondconfirmation) { // Show if not last page ?>
          <a href="<?php printf("%s?pageNum_viewsecondconfirmation=%d%s", $currentPage, $totalPages_viewsecondconfirmation, $queryString_viewsecondconfirmation); ?>">Last</a>
          <?php } // Show if not last page ?></td>
    </tr>
  </table>
...
?>
      ...
      <tr valign="baseline">
      <td nowrap="nowrap" align="right">Best Man:</td>
      <td><input type="text" name="best_man"  value="<?php echo htmlentities($row_editmarriage['best_man'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>   <tr valign="baseline">
      <td nowrap="nowrap" align="right">Best Maid:</td>
      <td><input type="text" name="best_maid"  value="<?php echo htmlentities($row_editmarriage['best_maid'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr> 
...
$totalRows_addleader1 = mysql_num_rows($addleader1);?>
    ...
    <tr valign="baseline">
      ...
      <td>
        <select name="leaderid" selected="selected">
       <option value="-1"  <?php if (!(strcmp(-1,$row_editmarriage['marriageid']))) {echo "selected=\"selected\"";} ?>>Select Leader</option>
       <?php
do {  
?>
       <option value="<?php echo $row_addleader1['memberid']?>"<?php if (!(strcmp($row_addleader1['memberid'], $row_editmarriage['marriageid']))) {echo "selected=\"selected\"";} ?>><?php echo $row_addleader1['firstname']?> <?php echo $row_addleader1['middlename']?> <?php echo $row_addleader1['lastname']?></option>
       <?php
} while ($row_addleader1 = mysql_fetch_assoc($addleader1));
...
$totalRows_marriagewife = mysql_num_rows($marriagewife);
   ...
   ?>
      ...
      <tr>
        ...
        <td><?php echo $row_marriagehusband['middlename']; ?>&nbsp;<?php echo $row_marriagehusband['firstname']; ?>&nbsp;<?php echo $row_marriagehusband['lastname']; ?> </td>
        
     <td><?php echo $row_viewmarriage['middlename']; ?>&nbsp;<?php echo $row_viewmarriage['firstname']; ?>&nbsp;<?php echo $row_viewmarriage['lastname']; ?> </td>
        <td><?php echo $row_marriage['middlename']; ?>&nbsp;<?php echo $row_marriage['firstname']; ?>&nbsp;<?php echo $row_marriage['lastname']; ?> </td>
        <td><?php echo $row_marriagewife['firstname']; ?>&nbsp;<?php echo $row_marriagewife['middlename']; ?>&nbsp;<?php echo $row_marriagewife['lastname']; ?></td> 
        <td><?php echo $row_viewmarriage['date']; ?>&nbsp; </td>
...
<td><a href="index.php?sacraments=show & marriageid=<?php echo $row_viewmarriage['marriageid'];?> & Delete=1 &#tabs-4" onClick="return confirm('Are you sure you want to delete?')"> Delete </a></td>
      </tr>
  ...
  <table border="0">
    <tr>
      <td><?php if ($pageNum_viewmarriage > 0) { // Show if not first page ?>
          <a href="<?php printf("%s?pageNum_viewmarriage=%d%s", $currentPage, 0, $queryString_viewmarriage); ?>">First</a>
          <?php } // Show if not first page ?></td>
      <td><?php if ($pageNum_viewmarriage > 0) { // Show if not first page ?>
          <a href="<?php printf("%s?pageNum_viewmarriage=%d%s", $currentPage, max(0, $pageNum_viewmarriage - 1), $queryString_viewmarriage); ?>">Previous</a>
          <?php } // Show if not first page ?></td>
      <td><?php if ($pageNum_viewmarriage < $totalPages_viewmarriage) { // Show if not last page ?>
          <a href="<?php printf("%s?pageNum_viewmarriage=%d%s", $currentPage, min($totalPages_viewmarriage, $pageNum_viewmarriage + 1), $queryString_viewmarriage); ?>">Next</a>
          <?php } // Show if not last page ?></td>
      <td><?php if ($pageNum_viewmarriage < $totalPages_viewmarriage) { // Show if not last page ?>
          <a href="<?php printf("%s?pageNum_viewmarriage=%d%s", $currentPage, $totalPages_viewmarriage, $queryString_viewmarriage); ?>">Last</a>
          <?php } // Show if not last page ?></td>
    </tr>
  </table>
