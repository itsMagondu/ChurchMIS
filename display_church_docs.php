...
mysql_select_db($database_church, $church);
$query_pics = "SELECT * FROM church_doc ";
...
<table border="1" align="center" width="100%">
  <tr>
    ...
    <td width="5%"></td>
      ...
      <td><a href="church_docs/<?php echo $row_pics['church_doc_name'];?>" >open</a></td>
            <td><a href="index.php?church=<?php echo $row_pics['church_doc_id']?>&pageNum_pics=<?php echo  $pageNum_pics ?> &church=true & #tabs-3">Edit</a></td>
