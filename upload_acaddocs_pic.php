...
$query_thispic = "SELECT * FROM church_doc ";
...
if((!empty($_FILES["photo"])) && ($_FILES['photo']['error'] == 0)) {
  ...
  $ext = substr($filename, strrpos($filename, '.') + 1);
    ...
    //Determine the path to which we want to save this file
      $newname = dirname(__FILE__).'/scanned_docs/'.$filename;
...
if ((isset($_GET['docid'])) && ($_GET['docid'] != "")) {
  mysql_query("UPDATE church_doc SET acad_doc_name='$filename', doc_title='$doc_title' WHERE acad_doc_id=".$acad_id."");

           echo "It's done! The file has been Updated as: ".$newname;
		    

}else{	 mysql_query("INSERT INTO church_doc (doc_title, church_doc_name) VALUES ('$filename', '$doc_title')") ; 
...
if ((isset($_GET['docid'])) && ($_GET['docid'] != "") && isset($_POST['Deletepic'])) {
	$acad_id=$_GET['docid'];
$whereto="index.php?church=true & #tabs-3";
$image=$_POST['kakufutwo'];
 ...
 $delpic=@mysql_query("DELETE FROM church_doc WHERE acad_doc_id=".$acad_id."")or die(mysql_error());
...
" />
  ...
  <tr>
    ...
    <td><input type="file" name="photo" value="<?php echo $row_thispic['acad_doc_name'];?>
"/></td>
  </tr>
  <tr>
...
" />
    ...
    <tr valign="baseline">
      ...
      <td><?php echo htmlentities($row_thispic['photo'], ENT_COMPAT, 'utf-8'); ?><input type="file" name="photo" value="<?php echo $row_thispic['acad_doc_name'];?>
"/>
      <input name="kakufutwo" type="text" id="kakufutwo" value="<?php echo $row_thispic['acad_doc_name'];?>" /></td>
    </tr>
    <tr valign="baseline">
  ...
  <input type="hidden" name="employee_id" value="<?php echo $row_thispic['employee_id']; ?>" />
<?php }?></form> 
<p>&nbsp;</p>
</body>
</html>
